...
namespace clas12 {
  ...
  public:
    ...
    //this should include getting the item order from the bank
    virtual void init(const char *bankName, hipo::reader &r,std::string items="");
   ...
   /*  } */
    ...
    void notify() override { scanIndex(); }
